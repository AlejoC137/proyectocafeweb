...
import { ClipboardList, Unlock, Lock, FileJson, Printer, X } from "lucide-react";

export function ProcedimientoHeader({
  menuItem,
  receta,
  rendimientoDisplay,
  porcentaje,
...
export default ProcedimientoHeader;
