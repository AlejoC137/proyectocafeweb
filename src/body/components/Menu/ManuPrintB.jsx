...
import {
    CAFE, CAFE_ESPRESSO, CAFE_METODOS,
    BEBIDAS, BEBIDAS_CALIENTES, BEBIDAS_FRIAS,
    DESAYUNO, DESAYUNO_DULCE, DESAYUNO_SALADO,
    TARDEO, TARDEO_ALMUERZO,
    PANADERIA, PANADERIA_REPOSTERIA_SALADA, 
    REPOSTERIA, PANADERIA_REPOSTERIA_DULCE,
    ADICIONES, ADICIONES_BEBIDAS, ADICIONES_COMIDAS
} from '../../../redux/actions-types';

export default function MenuPrintB({ menuData, leng }) {
  return (
    <div
        className="bg-[#fcfbf9] text-black shadow-2xl print:shadow-none w-[11in] h-[17in] border print:border-none mx-auto overflow-hidden flex flex-col box-border print:break-after-page mt-8 print:mt-0"
    >
