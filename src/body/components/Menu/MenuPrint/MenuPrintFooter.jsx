  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 ml-5">
        <span>¿te gusto nuestro servicio? porfavor danos una calificacion en Google Maps</span>
        <span>¿tienes algun evento o proyecto que quieras que hagamos realidad? contactanos!</span>
        <span>+57 300 821 4593 @PROYECTO__CAFE</span>
      </div>
    </div>
  );
};
