...
const MenuPrintHeader = ({ colors, leng }) => {
  return (
    <div
      className="border-[3px] px-2 py-2 md:py-2 mb-3 shadow-[8px_8px_0px_0px] flex justify-between items-center rounded-[8px] relative z-10 gap-2"
      style={{
        backgroundColor: 'rgba(255, 255, 255, 0.85)',
        borderColor: colors.mainBorder,
        boxShadow: `8px 8px 0px 0px ${colors.mainBorder}`
      }}
    >
      <div className="flex items-center gap-8 flex-1 min-w-0">
        <img src={BaseSillaLogo} alt="Logo" className="h-8 md:h-12 w-auto ml-1   object-contain" />
        <h1
          className="text-5xl lg:text-1xl font-black tracking-tighter uppercase leading-none m-0 p-0 truncate"
