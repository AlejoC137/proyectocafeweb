...
export const SET_CURRENT_STAFF = "SET_CURRENT_STAFF"; // Estado global de usuario logueado
// Vistas
...
export const VIEW_PREFERENCES_TABLE = 'view_preferences';
// Areas
...
export const CAFE_GRANO = 'CAFE_GRANO'
