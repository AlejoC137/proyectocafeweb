...
export function CardInstancePrintHead({ product, isEnglish }) {
    ...
    <Card className="w-full h-full overflow-hidden pt-0 pl-1 pr-1 shadow-none" onClick={() => setShowDetail(true)}>
      ...
      <CardContent className="p-0 flex flex-col justify-between text-gray-900 font-light">
        <div className="flex justify-between items-center  border-b border-black">
          ...
          <h3 style={{ fontSize: '40px' }} className="text-10pt truncate w-full font-bold font-custom font-SpaceGrotesk">
          ...
          <span className="font-semibold text-gray-800 font-SpaceGrotesk" style={{ fontSize: '40px' }}>
            ${formatPrice(product.Precio)}
          </span>
        </div>
        <div className="flex justify-between items-center">
          <h3 className="text-md font-medium line-clamp-2 font-SpaceGrotesk" style={{ fontSize: '30px' }}>
