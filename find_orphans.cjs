...
const usedFiles = [
    ...
    'body/views/actividades/Comanda.jsx',
    'body/views/actividades/ComandaCreator.jsx',
    ...
    'body/views/inventario/gridInstance/CardGridComanda.jsx',
    'body/views/inventario/gridInstance/CardGridComanda_Instance.jsx',
    ...
    'body/views/staff/staffComandas.jsx',
    'body/views/staff/staffComandas_Instance.jsx',
